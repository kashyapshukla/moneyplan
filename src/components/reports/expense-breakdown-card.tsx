  ...
  return (
    <>
      ...
      <button
        ...
        className="rounded-xl border bg-white p-5 text-left w-full hover:border-slate-300 hover:shadow-sm transition-all group"
      >
        ...
        >
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between">
              <span className="text-sm text-slate-500">Total avg / month</span>
